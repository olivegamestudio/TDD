...
The game also draws now: starting a game puts the ship on screen, turned to the heading the
physics is holding, and the camera follows it wherever it flies.
