...
| 4. The world was here first | Partly expressed. The save now carries the first thing the player *has* rather than merely where they are — the ship they were awarded is recorded and restored rather than re-derived on load. The rest of a persistent record (experience, credits, quest history) is still missing, and world progression currently advances from the game screen. |
