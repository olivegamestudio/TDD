...
| 4. The world was here first | Partly expressed. The record has started to separate from perishable position: the save now carries the ship the player was awarded, recorded rather than re-derived, so a hull earned survives a reload. Experience, credits and quest history are still absent, and world progression still advances from the game screen. |
