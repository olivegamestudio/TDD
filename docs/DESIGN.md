...
| 4. The world was here first | Partly expressed. The save now carries what the player owns as well as where they are: the ship awarded on a new game is recorded and given back on a reload, and an identifier this build does not recognise falls back to the starting ship rather than discarding the record. Still short of the pillar: ownership is one ship and nothing else — no experience, credits or quest history — and world progression still advances from the game screen. |
