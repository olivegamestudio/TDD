...
| 4. The world was here first | Partly expressed. The save now carries the ship the player owns as well as their position and quest state, so the first thing they own outlives a reload. Still short: there is no experience, credits or quest history, nothing yet separates the record that survives death from the position that does not, and world progression currently advances from the game screen. |
