...
public sealed class Player
{
    ...
    /// or resumes a game, and only then is there a ship. Nothing should be flying or drawing a
    /// player until the session reports itself ready, by which point this is set.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Awarding is not a move. A player handed a better ship keeps the position they were at, and a
    /// player resuming a save is placed and awarded independently, so neither ordering can quietly
    /// teleport them.
    /// </remarks>
