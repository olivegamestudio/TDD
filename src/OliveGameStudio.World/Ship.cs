...
/// makes a ship something a save can name and hand back.
/// </para>
/// <para>
/// Both strings are identifiers, not text. <see cref="Id"/> is written into save games and
/// <see cref="AssetKey"/> names a file on disk; translating either would mean a game saved in one
/// language could not be loaded in another, and a ship that draws in English would draw as nothing
/// in German. A ship's <em>name</em>, when the player is ever shown one, is a separate translated
...
/// drawing it is the presentation's job.
/// </param>
